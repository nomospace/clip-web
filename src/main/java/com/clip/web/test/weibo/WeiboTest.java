...
public class WeiboTest {
    public static void main(String[] args) {
        ...
        String authorizeUri = "https://api.weibo.com/oauth2/authorize";
        String accessTokenUri = "https://api.weibo.com/oauth2/access_token";
        String apiHost = "https://api.weibo.com";
